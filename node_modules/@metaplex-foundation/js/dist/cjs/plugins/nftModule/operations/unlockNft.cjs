 ...
 */
const unlockNftOperation = Operation.useOperation(Key);
 ...
 * @category Handlers
 */
const unlockNftOperationHandler = {
 ...
 * @category Constructors
 */
const unlockNftBuilder = (metaplex, params, options = {}) => {
  const {
    programs,
  ...
  .add({
    instruction: mplTokenMetadata.createUnlockInstruction({
...
exports.unlockNftBuilder = unlockNftBuilder;
exports.unlockNftOperation = unlockNftOperation;
exports.unlockNftOperationHandler = unlockNftOperationHandler;
//# sourceMappingURL=unlockNft.cjs.map
